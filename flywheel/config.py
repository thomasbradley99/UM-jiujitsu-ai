...
# Override at runtime with FLYWHEEL_AGENT_ID for parallel experiments
# (e.g. multiple replay arcs without clobbering each other's MuBit outcomes).
AGENT_ID = os.environ.get("FLYWHEEL_AGENT_ID") or "submission-detector-naive"
...
# Override at runtime with FLYWHEEL_SEED_PROMPT (filename relative to PROMPTS_DIR).
SEED_PROMPT = PROMPTS_DIR / (
    os.environ.get("FLYWHEEL_SEED_PROMPT") or "verifier_naive.md"
)
